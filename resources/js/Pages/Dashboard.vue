                    ...
                    <form action="#">
                        <div class="grid gap-6">
                            <div class="col-span-6 ">
                                <label for="ticket"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomor Tiket anda adalah</label>
                            ...
                            <p class="text-sm font-medium text-gray-900 dark:text-white">Tunjukan tiket anda pada petugas untuk bisa masuk kedalam event !</p>
                        </div>
                    </form>
                </div>
                <div v-else
                    ...
                    <form action="#">
                        <div class="grid gap-6">
                            <p class="text-sm font-medium text-gray-900 dark:text-white">Silahkan klik daftar agar mendapatkan tiket masuk</p>
