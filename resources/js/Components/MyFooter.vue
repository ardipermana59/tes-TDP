    ...
    <div>
        <footer
            ...
            <ul class="flex flex-wrap items-center mb-6 space-y-1 md:mb-0">
                ...
                <li>
                    <Link href="#" class="text-sm font-normal text-gray-500 hover:underline dark:text-gray-400">Contact
                    </Link>
                </li>
            </ul>
        ...
        <p class="my-10 text-sm text-center text-gray-500">
            © 2019-2023
            <Link href="/" class="hover:underline" target="_blank">Flowbite.com</Link>.
            All rights reserved.
        </p>
    </div>
</template>